      ...
      <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780  ">
        ...
        <div className="mt-10 flex gap-10 flex-wrap justify-center">
          <div className=" border-r-1 border-color m-4 pr-10">
            ...
            <div className="mt-5">
              <SparkLine id="line-sparkLine" currentColor={currentColor} type="Line" height="80px" width="250px" data={SparklineAreaData} color={currentColor} />
            </div>
            <div className="mt-10">
              <Button
                color="white"
...
style={{
  //  backgroundImage: "url('/src/data/welcome-bg.svg')",
    backgroundSize: 'flex', // Adjust this value based on your preference
    backgroundRepeat: 'no-repeat',
    backgroundPosition: 'center center',
    height: '200px', // Adjust this value based on your preference
  }}>*/